...
lable_dummy1 = Label(root, text="", bg="blue")
...
lable_dummy2 = Label(root, text="", bg="blue")
...
lable_dummy3 = Label(root, text="", bg="blue")
...
lable_dummy4 = Label(root, text="", bg="blue")
...
lable_dummy5 = Label(root, text="", bg="blue")
...
lable_dummy6 = Label(root, text="", bg="blue")
...
lable_dummy7 = Label(root, text="", bg="blue")
...
lable_dummy8 = Label(root, text="", bg="blue")
...
lable_dummy9 = Label(root, text="", bg="blue")
lable_dummy9.grid(row=17, column=0, columnspan=7)

lable10_res = Label(root, text="", bg="blue")
